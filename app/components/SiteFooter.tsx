    ...
    <footer className={`${styles.footer} ${spaceMono.className}${className ? ` ${className}` : ''}`}>
      ...
      <div className={styles.row}>
        <nav className={styles.nav}>
          ...
          <CurtainLink href="/blog" className={styles.navLink} curtainTransition>Writing</CurtainLink>
        ...
        <div className={styles.icons}>
          <a
            href="https://github.com/optimusjames"
          ...
          <a
            href="https://www.linkedin.com/in/optimizationmason/"
            className={styles.iconLink}
            target="_blank"
            rel="noopener noreferrer"
          ...
          <ShellEasterEgg variant="dark" className={styles.egg} />
        </div>
      </div>
    </footer>
  )
