...
import SkullEasterEgg from '@/app/components/SkullEasterEgg'
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.siteFooterRow}>
          <nav className={styles.siteNav}>
            <CurtainLink href="/design-experiments" className={styles.siteNavLink} curtainTransition curtainReverse>Design</CurtainLink>
            <CurtainLink href="/blog" className={styles.siteNavLink} curtainTransition>Blog</CurtainLink>
            <CurtainLink href="/docs" className={styles.siteNavLink} curtainTransition>Docs</CurtainLink>
            <CurtainLink href="/recommended" className={styles.siteNavLink} curtainTransition>
