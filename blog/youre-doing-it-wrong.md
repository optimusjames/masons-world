...
**The shift isn't tools to better tools. It's tools to no tools, just creation.**
...
- Fluency in natural language prompting
- Intuition for agent collaboration
- Speed of iteration (generate, verify, iterate loops)
- Comfort with ephemeral creation
...
- Theorized about AI from the sidelines
- Waited for "the right tool" to emerge
- Got paralyzed by "why bother, it's all changing"
- Stuck to old workflows because they're comfortable

**Those who will thrive:**

- Built throwaway projects just to practice
- Developed intuition by doing
- Got comfortable with rapid change
- Learned to work with agents, not around them
...
- **Coding in public** -- Every experiment, every iteration, every commit visible on GitHub
- **Working with an AI agent** -- Built directly in terminal with Claude Code, no design tools
- **Rapid experimentation** -- From concept to deployed experiment in minutes, not hours
- **Remixing ideas** -- Typography from Spec Sheet. Layout patterns from Color Spec. Techniques combine and evolve.
...
You can see every commit, every experiment, every iteration at [github.com/joshcoolman-smc/sandbox](https://github.com/joshcoolman-smc/sandbox). It's not perfect. It's not polished. It's a workshop, not a portfolio.
